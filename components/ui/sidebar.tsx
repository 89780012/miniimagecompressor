      ...
      return (
        ...
        >
          ...
          <div
            ref={ref}
            className={cn(
              "fixed h-full w-[--sidebar-width-mobile] bg-sidebar p-2 text-sidebar-foreground shadow-md transition-transform duration-200 ease-in-out",
              side === "left"
                ? "left-0"
                : "right-0",
              openMobile
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex h-8 w-8 items-center justify-center rounded-md text-sidebar-foreground transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
        className
      )}
      onClick={(event) => {
        onClick?.(event)
...
>(({ className, ...props }, ref) => {
  return (
    <input
      ...
      data-sidebar="input"
      className={cn(
        "flex h-8 w-full rounded-md border border-sidebar-border bg-background px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sidebar-foreground file:text-sm file:font-medium placeholder:text-sidebar-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
